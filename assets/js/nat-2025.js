...
function changeExamType() {
    ...
    if (select_test_type && select_test_type == "2") {
        ...
        product_catID = 61;
    } else if (select_test_type && select_test_type == "6") {
        examType = 6;
        TEST_TYPE = "VINit";
        $('.for_viq').show();
        productIdGlobal = 12235;
        product_catID = 64;
    } else {
        examType = 3;
        TEST_TYPE = "VIQ";
...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        if ((urlParams.get('special_link') == "VMCDMRC" || urlParams.get('special_link') == "vmcdmrc")) {
            is_special = true;
            special_coupon = "VMCDMRC";
        }
    } else {
        is_special = false;
    }
...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            //NAT
            if (selectedNatDate.id == 496 || selectedNatDate.id == 497 || selectedNatDate.id == 499 || selectedNatDate.id == 500 || selectedNatDate.id == 501 || 
                selectedNatDate.id == 503 || selectedNatDate.id == 504 || selectedNatDate.id == 506 || selectedNatDate.id == 507 )
            {
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (selectedNatDate.id == 502 || selectedNatDate.id == 505 || selectedNatDate.id == 506 || selectedNatDate.id == 507) {
...
$('#select_course').on('change', function() {
    // if(this.value == '64' || this.value == '74' || this.value == 64 || this.value == 74)
    // {
    //    let msg = "please take direct admission";
    //    $("#test_course_msg").html('Direct admission : ' + msg).css({
    //            "marginBottom": "1rem"
    //        });

    // }else{

    //    $("#test_course_msg").html('');
    // }
});

/********** end surendra 17-07-2024  ** **** */
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 400 || selectedNatDate.id == 421 || selectedNatDate.id == 422 || selectedNatDate.id == 423 || selectedNatDate.id == 425 || selectedNatDate.id == 426)) {
                document.getElementById("couponCode").value = 'VIQPLUS99';
            } else if ((selectedNatDate.id == 400 || selectedNatDate.id == 421 || selectedNatDate.id == 422 || selectedNatDate.id == 423 || selectedNatDate.id == 425 || selectedNatDate.id == 426 || selectedNatDate.id == 400 || selectedNatDate.id == 401) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                    centre_code == 182 || centre_code == 179 || centre_code == 180 || centre_code == 181 || centre_code == 154 || centre_code == 156 || centre_code == 155 ||
                    centre_code == 160 || centre_code == 164 || centre_code == 117 || centre_code == 123 || centre_code == 141 || centre_code == 144 || centre_code == 148 || centre_code == 150 ||
                    centre_code == 159 || centre_code == 130 || centre_code == 161 || centre_code == 172)) {
                document.getElementById("couponCode").value = 'VIQPLUS99';
            }
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if ((selectedNatDate.id == 396 || selectedNatDate.id == 400 || selectedNatDate.id == 421 || selectedNatDate.id == 424 || selectedNatDate.id == 425)) {
                    document.getElementById("couponCode").value = 'VIQPLUS49';
                }
            }
            document.getElementById("btn_remove_coupon").disabled = true;
            applyCoupon();
...
function updateUIAsPerCartInfo() {
    ...
    if (isDiscount) {
        htmlInfo = '<span style="font-size: 15px; text-decoration: line-through; text-decoration-color: red;">&#8377 999</span><span style="font-size: 24px; margin-left: 10px;">&#8377 ' + parseInt(userCartSummery.total_amount) + " Only</span>";
    } else {
...
function couponCodeAppliedSuccessfully() {
    ...
    let htmlInfo = '<img id="couponcode_status_img" width="20" height="20" alt="success" src="https://www.vidyamandir.com/img/coupon_apply_success.png"/><span id="couponcode_status_msg" style="margin-left:10px;font-size:12px;">Coupon code applied successfully.</span>';
    document.getElementById("couponcode_status").innerHTML = htmlInfo;
}

function couponCodeApplyError(errorMessage) {
    let htmlInfo = '<img id="couponcode_status_img" width="20" height="20" alt="error" src="https://www.vidyamandir.com/img/coupon_apply_error.png"/><span id="couponcode_status_msg" style="margin-left:10px;font-size:12px">' + errorMessage + "</span>";
...
function updateCoursesOptions(courseListJSON) {
    ...
    // if ((select_test_mode.value == "Offline" || select_test_mode.value == "offline")) {
    //     option.value = course.code;
    //     if (option.value == "22" || option.value == "23" || option.value == "62" || option.value == "63") {
    //         option.value = course.code;
    //         option.text = course.value;
    //         elCourses.add(option);
    //     }
...
function updateCentersOptions(centerListJSON) {
    ...
    /** Added By surendra  2023-09-19*/
    var selectedCourse = document.getElementById("select_course").value.trim();

    /** Added By surendra  2023-11-25*/
    var selectedDateTime = document.getElementById("select_nat_date").value.trim();
    ...
    elCenter.add(option);
    /**END* && (selectedDateTime == 'VMC NAT 17 Mar 2024 10 AM - 12:30 PM')/

    /** Added By surendra  2023-11-25*/
    /** End  2023-09-19*/
    console.log(centerListArr.length);
