...
function updateUIAsPerCartInfo() {
    ...
    if (isDiscount) {
        ...
        htmlInfo = '<span style="font-size: 15px; text-decoration: line-through; text-decoration-color: red;">&#8377 999</span><span style="font-size: 22px;margin-left: 10px;color: #d20000;font-weight: 700;">&#8377 ' + Couponlaodproce + " Only</span>";
...
function couponCodeApplyError(errorMessage) {
    let htmlInfo = '<img id="couponcode_status_img" width="20" height="20" alt="error" src="https://www.vidyamandir.com/img/coupon_apply_error.png"/><span id="couponcode_status_msg" style="margin-left:10px;font-size:10px">' + errorMessage + "</span>";
